...
public:
    ...
    void setupUi(QWizard *Installwizard)
    {
        ...
        driveLabel->setGeometry(QRect(32, 46, 420, 20));
        treePartitions = new QTreeWidget(partitionPage);
        treePartitions->setObjectName("treePartitions");
        treePartitions->setGeometry(QRect(30, 72, 420, 200));
        ...
        partRefreshButton->setGeometry(QRect(230, 276, 79, 30));
        createPartButton = new QPushButton(partitionPage);
        createPartButton->setObjectName("createPartButton");
        createPartButton->setGeometry(QRect(316, 276, 165, 30));
        ...
        verticalLayoutWidget->setGeometry(QRect(44, 34, 221, 29));
        ...
        verticalLayoutWidget_2->setGeometry(QRect(286, 34, 141, 31));
        ...
        verticalLayoutWidget_4->setGeometry(QRect(146, 74, 107, 139));
